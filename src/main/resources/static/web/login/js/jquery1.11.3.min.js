...
function internalData( elem, name, data, pvt /* Internal Use Only */ ) {
	...
	var ret, thisCache,
		...
		// the core to shortcut on the same path as a DOM node with no cache
...
(function() {
	...
	function computeStyleTests() {
		...
		// Check for getComputedStyle so that this core is not run in IE<9.
		if ( window.getComputedStyle ) {
	...
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			if ( ( value >= 1 || value === "" ) &&
				...
				// style.removeAttribute is IE Only, but so apparently is this core path...
...
$.getRootPath=function(){
	...
	var projectName=pathName.substring(0,pathName.substr(1).lastIndexOf('/')+2);
