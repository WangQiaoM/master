...
_e(function (E, $) {
    ...
    Txt.fn.bindFormatText = function () {
        ...
        // 增加 core
        regArr.push(new RegExp('\>\\s*\<(core)\>', 'ig'));
...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        source: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-core"></i></a>',
            selected: '.selected'
        },
        fontfamily: {
    ...
    E.createMenu(function (check) {
        ...
        menu.clickEvent = function (e) {
            ...
            if (!self.$codeTextarea) {
                self.$codeTextarea = $('<textarea class="core-textarea"></textarea>');
            }
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        function contentHandle($content) {
            ...
            // 确定按钮
            var codeTpl = '<pre style="max-width:100%;overflow-x:auto;"><core{#langClass}>{#content}</core></pre>';
            $btnSubmit.click(function (e) {
                e.preventDefault();
                ...
                var doHightlight = function () {
                    $txt.find('pre core').each(function (i, block) {
                        var $block = $(block);
